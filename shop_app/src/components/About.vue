<template>
    <div>
        <article id="history">
            <br>
            <img src="../assets/FB_aboutus.png" alt="Street thugs wearing FUBU">
            <p>What began as a bunch of hats made in Daymond John’s Hollis Queens’ home by he and his close friends have turned the partners of FUBU into leaders in one of the most successful sportswear companies of all time and the creators of a whole category of marketing innovations that are now considered to be staples of industry.</p>
        ...
        <article id="keith">
            ...
            <p>To connect with the hottest station in urban life, check out www.fuburadio.com</p><hr color="white">
            <br>
            <p id="kquotes">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;“Anyone can dress someone. However, I look at the person, their personal style, and that’s what I try to cater to when we provide them with items from our collection.” – Keith Perrin </p><hr color="white">
            <br>
        </article>
        <article id="jalexander">
